...
export const Gallery: FC<GalleryProps> = ({ showFeatured = false, category, limit }) => {
  ...
  const BeforeAfterComparison: FC<BeforeAfterComparisonProps> = ({ item, showBefore: localShowBefore, onToggle }) => (
