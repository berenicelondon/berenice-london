...
export const CartDrawer: FC<CartDrawerProps> = ({ children }) => {
...
export const ControlledCartDrawer: FC<ControlledCartDrawerProps> = ({ isOpen, onClose, memberDiscount = 0 }) => {
  const { items, updateQuantity, removeFromCart, getTotalItems, getTotalPrice, clearCart } = useCart()

  const formatPrice = (price: number, withDiscount = false) => {
