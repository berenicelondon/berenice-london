            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  This is a demonstration of the checkout process. Payment processing is temporarily disabled.
                  All transactions are simulated and no charges will be made.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6">
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-green-800">Payment Methods Ready</span>
              </div>
              <p className="text-sm text-green-700 mt-1">
                Apple Pay and credit card processing will be available when Stripe is configured.
              </p>
            </div>
          </div>
